...
public class C01_XPath {
    public static void main(String[] args) throws InterruptedException {
       ...
       // WebElement addButonu= driver.findElement(By.xpath("//button[text()='Add Element']"));
        ...
        WebElement addButonu= driver.findElement(By.xpath("//button[@onclick()='Add Element']"));
        addButonu.click();
       ...
       if (deleteButonu.isDisplayed()) {
        ...
        //eger butone bastiginizda HTML kodundaki satirda siliniyorsa
        //driver in o elemente ulasmasi mumkun olmayacagindan
        //varligini yada yoklugunu test etmemiz mumkun olmaz
        //varolan bir element bu sekilde silindikten sonra locat etmeye calisirsak
